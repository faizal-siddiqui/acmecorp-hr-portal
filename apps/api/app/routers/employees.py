...
async def get_employee_detail(employee_id: int, db: AsyncSession = Depends(get_db)):
    service = EmployeeService(db)
...
async def get_employee_history(employee_id: int, db: AsyncSession = Depends(get_db)):
    service = EmployeeService(db)
...
async def update_employee_status(
    employee_id: int, data: EmployeeStatusUpdate, db: AsyncSession = Depends(get_db)
):
    service = EmployeeService(db)
